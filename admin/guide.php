...
<div class="space-y-8 pb-20 font-serif-lao">
    ...
    <!-- Hero Banner with inline dark burgundy gradient style so background renders 100% dark -->
    <div class="relative overflow-hidden p-6 sm:p-10 rounded-3xl shadow-xl" style="background: linear-gradient(135deg, #1A050B 0%, #531321 50%, #6B1D2F 100%); color: #ffffff; border: 1px solid rgba(217, 119, 6, 0.3);">
        <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div class="space-y-3 max-w-3xl">
                <div class="inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm" style="background-color: rgba(245, 158, 11, 0.2); color: #FDE68A; border: 1px solid rgba(245, 158, 11, 0.4);">
            ...
            <a href="../index.php" target="_blank" class="px-5 py-3 bg-amber-500 hover:bg-amber-400 text-gray-950 font-extrabold text-xs rounded-2xl shadow-lg transition-all flex items-center gap-2 shrink-0">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <a href="#section-frontend" class="p-5 bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-all flex flex-col items-center text-center space-y-2.5 group">
            <div class="w-12 h-12 rounded-xl bg-red-50 text-red-700 flex items-center justify-center group-hover:scale-110 transition-transform shadow-inner">
            ...
            <span class="text-xs sm:text-sm font-bold text-gray-900">1. ໜ້າເວັບໄຊອອນໄລນ໌</span>
        </a>

        <a href="#section-orders" class="p-5 bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-all flex flex-col items-center text-center space-y-2.5 group">
            ...
            <span class="text-xs sm:text-sm font-bold text-gray-900">2. ອໍເດີ & ຫ້ອງຄົວ</span>
        </a>

        <a href="#section-members" class="p-5 bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-all flex flex-col items-center text-center space-y-2.5 group">
            ...
            <span class="text-xs sm:text-sm font-bold text-gray-900">3. ສະມາຊິກ & ສິດທີມງານ</span>
        </a>

        <a href="#section-admin" class="p-5 bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-all flex flex-col items-center text-center space-y-2.5 group">
            ...
            <span class="text-xs sm:text-sm font-bold text-gray-900">4. ຈັດການເມນູ & ສາຂາ</span>
        </a>
    </div>
    ...
    <div id="section-frontend" class="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-200 space-y-6">
        <div class="flex items-center gap-3.5 border-b border-gray-200 pb-5">
            <div class="w-10 h-10 rounded-xl bg-red-800 text-white flex items-center justify-center font-bold text-base shadow-sm">1</div>
            <div>
                <h2 class="text-lg sm:text-xl font-bold text-gray-900">1. ຄູ່ມືການໃຊ້ງານໜ້າເວັບໄຊອອນໄລນ໌ (Frontend Website Guide)</h2>
                <p class="text-xs sm:text-sm text-gray-600 mt-0.5">ວິທີການສັ່ງອາຫານ, ຈອງໂຕະ, ສະໝັກສະມາຊິກ ແລະ ສະໝັກ Franchise</p>
            </div>
        </div>

        <div class="space-y-6">
            <!-- Step 1.1 -->
            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
                <h3 class="text-base font-bold text-gray-900 flex items-center gap-2.5">
                    <span class="w-7 h-7 rounded-lg bg-red-800 text-white text-xs flex items-center justify-center font-mono font-bold">A</span>
                ...
                <ol class="list-decimal list-inside text-xs sm:text-sm text-gray-800 space-y-3 leading-relaxed pl-1">
                    <li class="pl-2"><strong class="text-gray-900">ເລືອກໝວດໝູ່ສິນຄ້າ</strong>: ເຂົ້າໜ້າເວັບໄຊ ➔ ເລືອກໝວດໝູ່ ເຊັ່ນ: <span class="px-2 py-0.5 bg-gray-200 rounded text-gray-900 font-semibold">ກາເຟ</span>, <span class="px-2 py-0.5 bg-gray-200 rounded text-gray-900 font-semibold">ເບຍ</span>, <span class="px-2 py-0.5 bg-gray-200 rounded text-gray-900 font-semibold">ອາຫານ</span>, <span class="px-2 py-0.5 bg-gray-200 rounded text-gray-900 font-semibold">ເຄື່ອງດື່ມ</span>.</li>
                    <li class="pl-2"><strong class="text-gray-900">ເພີ່ມສິນຄ້າເຂົ້າຕ່າ (Add to Cart)</strong>: ກົດປຸ່ມ <span class="px-2 py-0.5 bg-red-800 text-white font-bold rounded">+</span> ຢູ່ຮູບສິນຄ້າ ລະບົບຈະເພີ່ມສິນຄ້າເຂົ້າຕ່າຊື້ ແລະ ສະແດງຈຳນວນສິນຄ້າຢູ່ມຸມຂວາລຸ່ມ.</li>
                    ...
                    <li class="pl-2"><strong class="text-gray-900">ເລືອກຮູບແບບການຈັດສົ່ງ</strong>: 
                        <ul class="list-disc list-inside pl-6 mt-2 space-y-1.5 text-gray-800">
                    ...
                    <li class="pl-2"><strong class="text-gray-900">ຢືນຢັນການສັ່ງຊື້</strong>: ກົດປຸ່ມ <span class="px-3 py-1 bg-red-800 text-white font-bold text-xs rounded-lg">"ຢືນຢັນການສັ່ງຊື້"</span> ➔ ລະບົບຈະບັນທຶກອໍເດີເຂົ້າຖານຂໍ້ມູນ ແລະ ແຈ້ງເຕືອນໄປທີ່ <strong>ລະບົບຫຼັງບ້ານ (Admin Backoffice)</strong> ອັດໂນມັດ.</li>
                </ol>
            </div>
            ...
            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
                <h3 class="text-base font-bold text-gray-900 flex items-center gap-2.5">
                    <span class="w-7 h-7 rounded-lg bg-red-800 text-white text-xs flex items-center justify-center font-mono font-bold">B</span>
                ...
                <ol class="list-decimal list-inside text-xs sm:text-sm text-gray-800 space-y-2.5 leading-relaxed pl-1">
                    ...
                    <li class="pl-2">ກົດ <span class="px-3 py-1 bg-red-800 text-white font-bold text-xs rounded-lg">"ຢືນຢັນການຈອງໂຕະ"</span> ➔ ເມື່ອສຳເລັດ ຂໍ້ມູນຈະໄປສະແດງຢູ່ໜ້າ <strong class="text-gray-900">Admin ➔ ຈັດການຈອງໂຕະ</strong>.</li>
                </ol>
            </div>
            ...
            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
                <h3 class="text-base font-bold text-gray-900 flex items-center gap-2.5">
                    <span class="w-7 h-7 rounded-lg bg-red-800 text-white text-xs flex items-center justify-center font-mono font-bold">C</span>
                ...
                <ul class="list-disc list-inside text-xs sm:text-sm text-gray-800 space-y-2.5 leading-relaxed pl-1">
                    ...
                    <li class="pl-2"><strong class="text-gray-900">ການສະສົມຄະແນນ (Earn Points)</strong>: ທຸກໆການສັ່ງຊື້ສິນຄ້າອອນໄລນ໌ ເມື່ອ Admin ກົດ <span class="px-2 py-0.5 bg-green-100 text-green-800 font-bold rounded border border-green-300">"ຊຳລະແລ້ວ (Paid)"</span> ລະບົບຈະຄິດໄລ່ຄະແນນເຂົ້າບັນຊີສະມາຊິກອັດໂນມັດ.</li>
                    <li class="pl-2"><strong class="text-gray-900">ລະດັບ Tier ສະມາຊິກ</strong>: 
                        <span class="inline-flex flex-wrap gap-2 ml-2 mt-1">
                            <span class="px-2.5 py-0.5 bg-gray-200 text-gray-900 text-xs font-bold rounded border border-gray-300">Member</span>
    ...
    <div id="section-orders" class="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-200 space-y-6">
        <div class="flex items-center gap-3.5 border-b border-gray-200 pb-5">
            ...
            <div>
                ...
                <p class="text-xs sm:text-sm text-gray-600 mt-0.5">ວິທີຮັບອໍເດີ, ແຈ້ງເຕືອນສຽງ Realtime, ພິມໃບບິນ ແລະ ປ່ຽນສະຖານະອາຫານ</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
                ...
                <ul class="list-disc list-inside text-xs sm:text-sm text-gray-800 space-y-3 leading-relaxed">
                    <li><strong class="text-gray-900">ແຈ້ງເຕືອນອໍເດີໃໝ່ Real-time</strong>: ລະບົບຈະມີສຽງ Chime ແຈ້ງເຕືອນອັດໂນມັດທຸກໆ 4 ວິນາທີ ເມື່ອມີອໍເດີໃໝ່ເຂົ້າມາ.</li>
                    <li><strong class="text-gray-900">ປ່ຽນສະຖານະການຊຳລະ</strong>:
                        <ul class="list-circle list-inside pl-4 text-xs text-gray-800 mt-2 space-y-2">
                    ...
                    <li><strong class="text-gray-900">ພິມໃບບິນ/ໃບຮັບເງິນ</strong>: ກົດປຸ່ມ <span class="px-2.5 py-1 bg-gray-200 border rounded text-xs font-bold text-gray-900">🖨️ ພິມໃບບິນ</span> ເພື່ອພິມໃບສັ່ງຊື້ອອກເຄື່ອງພິມ Slip/POS.</li>
                </ul>
            </div>
    ...
    <div id="section-members" class="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-200 space-y-6">
        <div class="flex items-center gap-3.5 border-b border-gray-200 pb-5">
            ...
            <div>
                ...
                <p class="text-xs sm:text-sm text-gray-600 mt-0.5">ການກຳນົດສິດເຂົ້າເຖິງ, ເພີ່ມທີມງານ, Reset ລະຫັດຜ່ານ ແລະ ປົດລັອກບັນຊີ</p>
            </div>
        </div>
        ...
        <div class="space-y-6">
                ...
                <table class="w-full text-xs sm:text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-200 text-gray-800">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="p-3.5 font-bold text-gray-800 bg-gray-50">
                                <span class="px-2.5 py-1 bg-gray-200 text-gray-800 border border-gray-300 rounded-full font-bold inline-flex items-center gap-1">
                            ...
                            <td class="p-3.5 font-semibold text-gray-800">ສະໝັກຜ່ານໜ້າເວັບ</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <!-- Lockout explanation -->
            <div class="bg-red-50 p-6 rounded-2xl border border-red-200 space-y-3">
                ...
                <p class="text-xs sm:text-sm text-red-950 leading-relaxed">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 text-xs">
                    <div class="bg-white p-4 rounded-xl border border-red-200 shadow-sm space-y-1">
                        ...
                        <span class="text-gray-800">ປ້ອນຜິດ 3 ຄັ້ງ ➔ ລັອກ <strong>15 ນາທີ</strong></span>
                    </div>
                    <div class="bg-white p-4 rounded-xl border border-red-200 shadow-sm space-y-1">
                        <span class="font-bold text-red-900 block text-sm">ຂັ້ນທີ 2 (Stage 2)</span>
                        <span class="text-gray-800">ປ້ອນຜິດອີກ 3 ຄັ້ງ ➔ ລັອກ <strong>1 ຊົ່ວໂມງ</strong></span>
                    </div>
                    <div class="bg-white p-4 rounded-xl border border-red-200 shadow-sm space-y-1">
                        <span class="font-bold text-red-900 block text-sm">ຂັ້ນທີ 3 (Stage 3)</span>
                        <span class="text-gray-800">ປ້ອນຜິດອີກ 3 ຄັ້ງ ➔ ລັອກ <strong>24 ຊົ່ວໂມງ</strong> ຫຼື ຈົນກວ່າ Admin ຈະກົດ <span class="px-1.5 py-0.5 bg-green-100 text-green-800 border rounded font-bold">"🔓 ປົດລັອກ"</span></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="section-admin" class="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-200 space-y-6">
        <div class="flex items-center gap-3.5 border-b border-gray-200 pb-5">
            ...
            <div>
                ...
                <p class="text-xs sm:text-sm text-gray-600 mt-0.5">ວິທີເພີ່ມ/ແກ້ໄຂ ເມນູອາຫານ, ສາຂາຮ້ານ, ຂ່າວສານ, Banner ແລະ ຮູບພາບ Gallery</p>
            </div>
        </div>
