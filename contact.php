        ...
        <div class="lg:col-span-5 space-y-6">
            ...
            <div class="pt-4 border-t border-[#EBE4D8] space-y-3 font-sans-lao">
                ...
                <div class="flex items-center space-x-3 pt-1">
                    <!-- Instagram -->
                    <a href="https://www.instagram.com/laofe_beer?stkn=OG4wNGh0YmoxNWsw&utm_source=qr" class="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white flex items-center justify-center transition-all duration-300 shadow-md hover:scale-110" title="Instagram">
                    ...
                    <!-- Telegram -->
                    <a href="#" class="w-10 h-10 rounded-xl bg-[#26A5E4] text-white flex items-center justify-center transition-all duration-300 shadow-md hover:scale-110" title="Telegram">
