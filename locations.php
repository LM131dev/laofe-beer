            ...
            ?>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col md:flex-row card-hover-effect border border-[#EBE4D8]">
                    ...
                    <div class="md:w-1/2 p-8 flex flex-col justify-between space-y-6 bg-[#FAF7F2]">
                        ...
                        <div>
                            <a href="<?php echo htmlspecialchars($branch['map_link']); ?>" target="_blank" class="w-full inline-flex items-center justify-center gap-2.5 px-6 py-2.5 bg-gradient-to-r from-burgundy-700 via-burgundy-800 to-burgundy-900 hover:from-burgundy-600 hover:to-burgundy-800 text-white border border-amber-400/30 rounded-2xl text-sm font-extrabold transition-all duration-300 shadow-lg shadow-burgundy-950/20 hover:scale-[1.02] active:scale-95 font-serif-lao group">
                                <img src="assets/images/google_maps_icon.png" alt="Google Maps" class="w-5 h-5 object-contain shrink-0 group-hover:scale-110 transition-transform">
                                <span><?php echo t('loc_map'); ?></span>
                                <svg class="w-3.5 h-3.5 text-amber-400/80 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25"/></svg>
                            </a>
                        </div>
                    </div>
                </div>
